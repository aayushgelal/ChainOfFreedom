...
const Topbar = () => {
  return (
    <section className="sticky top-0 z-50 md:hidden  w-full  bg-black ">
        <div className="flex justify-between items-center py-4 px-5 ">
            ...
            <div className="flex gap-4 ">
                <Button
                variant="ghost"
                className="flex gap-4 text-white items-center justify-start hover:bg-transparent hover:text-white hover:bg-slate-800 !important"
